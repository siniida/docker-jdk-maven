...
# JDK8
RUN curl -O -L -b "oraclelicense=accept-securebackup-cookie" http://download.oracle.com/otn-pub/java/jdk/8u65-b17/jdk-8u65-linux-x64.rpm
RUN rpm -ivh jdk-8u65-linux-x64.rpm && rm jdk-8u65-linux-x64.rpm
